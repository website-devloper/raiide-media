        ...
        <div className="container">
          <div className="cs_main_header_in">
            ...
            <Link className="cs_site_branding" href="/">
                <img className="brand-logo-img" src="/assets/images/creative-agency/logo/logo raide.png" alt="Logo" />
              </Link>
              </div>
            ...
            <div className="cs_main_header_right">
              ...
              <a onClick={() => setSearchToggle(!searchToggle)} className="search-trigger search-icon"><i className="bi bi-search"></i></a>
                ...
                <Link href="/contact">
                <span className="theme-btn"> LET&apos;S TALK </span><span className="arrow-btn"><i className="bi bi-arrow-right"></i></span></Link>
                  </div>

                                ...
                                <div className="agenko-post-item pf_fadeup">
                                    <div className="main-post">
                                        ...
                                        <span><i className="bi bi-chat"></i>5 Comment</span>
                                            ...
                                            <p>A custom project approach designed to narrate the journey of your project, detailing its origins, inspirations, and key influences. Functionality to enhance healthcare delivery, streamline processes, and improve patient engagement and satisfaction</p>
                                            <blockquote>
                                                <div className="icon"><i className="flaticon-inverted-commas"></i></div>
                                                <h4>Raiide Media transformed our business with their innovative strategies and dedicated support. Their team understood </h4>

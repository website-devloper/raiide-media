...
const Testimonial3 = () => {
    ...
    const testimonialContent = [
        {subtitle:'CEO & Founder', title:'Ms. Alex Mika', content:'Raiide Media completely transformed our online presence! Their exceptional website development expertise to beyond expectations, creating a visually stunning and user-friendly website. The team is attention to detail and commitment to!'},
        {subtitle:'CEO & Founder', title:'Ms. Alex Mika', content:'Raiide Media completely transformed our online presence! Their exceptional website development expertise to beyond expectations, creating a visually stunning and user-friendly website. The team is attention to detail and commitment to!'},
      ]; 
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="text-box mb-45 pf_fadeup">
                                        <p>Discover how our clients achieved success with Raiide Media expert <span>web design and development</span>, delivering outstanding digital solutions.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
